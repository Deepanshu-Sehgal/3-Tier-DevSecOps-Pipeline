...
function Layout({ children }) {
  ...
  return (
    <div className="app-layout">
          ...
          <ul className="social-links">
            <li>
              <a
                ...
                href="https://www.linkedin.com/in/adityajaiswal7/"
                target="_blank"
            ...
            <li>
              <a
                className="sidebar-btn"
                href="https://www.youtube.com/@devopsshack"
                target="_blank"
                rel="noopener noreferrer"
              >
                YouTube
            ...
            <li>
              <a
                className="sidebar-btn"
                href="https://www.instagram.com/devopsshack"
                target="_blank"
                rel="noopener noreferrer"
              >
                Instagram
      ...
      <button className="help-btn" onClick={() => setShowInfo(true)}>
        ?
      </button>
